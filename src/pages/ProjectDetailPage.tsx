...
export const ProjectDetailPage = memo(function ProjectDetailPage({
  ...
  return (
    <div className="relative min-h-screen w-full text-white selection:bg-[#E8C582]/40 selection:text-white overflow-x-hidden">
      ...
      {/* Main Center Body Container (Darkened Translucent Panel for Maximum Text Readability) */}
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 md:px-8 pt-24 sm:pt-28 pb-16">
            ...
            <div className="space-y-2.5">
              {project.role && (
                <div className="flex items-baseline gap-2.5 text-stone-100" style={{ textShadow: '0 1px 4px rgba(0,0,0,0.9)' }}>
                  ...
                  <span className="font-serif italic text-base sm:text-lg text-[#FFD88A] font-normal leading-snug">{project.role}</span>
                </div>
              )}
              {project.client && (
                <div className="flex items-baseline gap-2.5 text-stone-100" style={{ textShadow: '0 1px 4px rgba(0,0,0,0.9)' }}>
                  <span className="text-stone-300 font-sans text-xs sm:text-sm font-medium">Client:</span>
                  <span className="font-serif italic text-base sm:text-lg text-white font-light leading-snug">{project.client}</span>
                </div>
              )}
              {project.year && (
                <div className="flex items-baseline gap-2.5 text-stone-100" style={{ textShadow: '0 1px 4px rgba(0,0,0,0.9)' }}>
                  <span className="text-stone-300 font-sans text-xs sm:text-sm font-medium">Year:</span>
              ...
              <div className="space-y-2">
                ...
                {project.demoUrl && (
                  <a
                    ...
                    className="group flex items-center justify-between px-3.5 py-2 rounded-xl bg-gradient-to-r from-amber-500 via-amber-400 to-amber-500 hover:from-amber-400 hover:to-amber-300 text-stone-950 font-sans font-bold text-xs tracking-wide shadow-[0_4px_16px_rgba(217,119,6,0.35)] hover:scale-[1.01] active:scale-[0.99] transition-all duration-150 cursor-pointer no-underline"
                  >
                ...
                {project.githubUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex items-center justify-between px-3 py-2 rounded-xl bg-[#24292e] hover:bg-[#2f363d] border border-white/20 text-white text-xs font-sans font-semibold shadow-sm hover:scale-[1.01] active:scale-[0.99] transition-all cursor-pointer no-underline"
                  >
                    <div className="flex items-center gap-2">
                ...
                {project.presentationUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex items-center justify-between px-3 py-2 rounded-xl bg-[#00c4cc]/20 hover:bg-[#00c4cc]/30 border border-[#00c4cc]/50 text-[#5fe3e8] text-xs font-sans font-semibold shadow-sm hover:scale-[1.01] active:scale-[0.99] transition-all cursor-pointer no-underline"
                  >
                    <div className="flex items-center gap-2">
                ...
                {project.videoUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex items-center justify-between px-3 py-2 rounded-xl bg-[#ff0000]/20 hover:bg-[#ff0000]/30 border border-[#ff0000]/50 text-[#ff7070] text-xs font-sans font-semibold shadow-sm hover:scale-[1.01] active:scale-[0.99] transition-all cursor-pointer no-underline"
                  >
                    <div className="flex items-center gap-2">
                ...
                {project.posterUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex items-center justify-between px-3 py-2 rounded-xl bg-indigo-500/20 hover:bg-indigo-500/30 border border-indigo-400/50 text-indigo-300 text-xs font-sans font-semibold shadow-sm hover:scale-[1.01] active:scale-[0.99] transition-all cursor-pointer no-underline"
                  >
                    <div className="flex items-center gap-2">
        ...
        {project.content && project.content.length > 0 && (
          <section className="pt-8 border-t border-white/20 max-w-4xl">
            <h2
