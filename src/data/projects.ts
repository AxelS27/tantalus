...
export const allProjectsData: ProjectItem[] = [
  ...
  },
  {
    ...
    description: 'An editorial 2D spatial canvas world combining classical Greek Renaissance aesthetics with high-performance GPU-accelerated camera glides and physics-driven 3D carousels.',
    thumbnail: '/images/tantalize/projects.webp',
    demoUrl: 'https://liemaxels.com',
    githubUrl: 'https://github.com/AxelS27/tantalus',
    tags: [
      'React 19',
      'TypeScript',
      'Motion',
    ...
    client: 'Personal Research & Portfolio',
    role: 'Lead Architect & Designer',
    year: '2026',
    content: [
      'Tantalus breaks away from traditional vertical scrolling web design, placing visitors inside a continuous multi-directional world of classical Greek Renaissance paintings with continuous edge feathering.',
      'The engine operates on a 2D continuous coordinate plane with cinematic camera glides, zero-jitter cubic easing, and hardware-accelerated 3D transforms.',
      'Features custom-built 3D cylindrical roller carousels, a rotating 3D project cube, Apple VisionOS frosted glassmorphic UI, and seamless deep link state synchronization.',
    ],
    gallery: [
      '/images/tantalize/projects.webp',
      '/images/tantalize/home.webp',
      '/images/tantalize/timeline.webp',
      '/images/tantalize/archives.webp',
      '/images/tantalize/certificates.webp',
      '/images/tantalize/connect.webp',
    ],
  },
  {
    id: 'apple-spatial',
    title: 'Spatial Audio & Vision Engine',
    description: 'A native spatial computing framework exploring binaural room impulse responses, hand-tracking kinematics, and real-time volumetric scene reconstruction.',
    thumbnail: 'https://media.liemaxels.com/images/career-trace/apple-academy.webp',
    githubUrl: 'https://github.com/AxelS27',
    tags: [
      'Swift',
      'SwiftUI',
    ...
    client: 'Apple Developer Academy Project',
    role: 'iOS & Spatial Computing Researcher',
    year: '2025',
    content: [
      'Developed during the Apple Developer Academy Cohort 8, this project investigates low-latency spatial audio simulation and hand interaction physics for spatial computing devices.',
      'Implements custom room acoustic convolution reverbs that adjust reverberation decay in real-time according to physical room dimensions and estimated surface absorption coefficients.',
      'Features 3D gesture tracking pipelines that process LiDAR depth streams to enable precise micro-pinch interactions with minimal latency.',
    ],
    gallery: [
      'https://media.liemaxels.com/images/career-trace/apple-academy.webp',
      '/images/tantalize/projects.webp',
      '/images/tantalize/connect.webp',
    ],
  },
  {
    ...
    description: 'A transformer-based hierarchical intent classification architecture optimized for high-throughput customer conversational systems with multi-label tagging.',
    thumbnail: 'https://media.liemaxels.com/images/career-trace/binus-malang.webp',
    githubUrl: 'https://github.com/AxelS27',
    tags: [
      'PyTorch',
      'Transformers',
    ...
    client: 'Binus University Research',
    role: 'ML Engineer',
    year: '2025',
    content: [
      'This research investigates transformer architectures for low-resource multi-turn intent recognition. Evaluates custom attention mechanisms designed to maintain long-range context without quadratic compute scaling.',
      'Features an automated data augmentation pipeline using contextual masked token replacement and back-translation to bolster representation for sparse classes.',
      'Achieved a 94.8% macro F1-score across 42 distinct intent classes, packaged as an asynchronous high-throughput inference microservice.',
    ],
    gallery: [
      'https://media.liemaxels.com/images/career-trace/binus-malang.webp',
      '/images/tantalize/timeline.webp',
    ],
  },
  {
    ...
    description: 'A real-time WebGL and GLSL raymarching engine rendering complex signed distance field (SDF) fractals and volumetric atmospheric scattering.',
    thumbnail: '/images/tantalize/connect.webp',
    githubUrl: 'https://github.com/AxelS27',
    tags: [
      'WebGL',
      'GLSL',
    ...
    client: 'Graphics Research',
    role: 'Graphics Programmer',
    year: '2025',
    content: [
      'A real-time GPU shader showcase implementing sphere tracing and raymarching for non-Euclidean geometry and dynamic fractal iteration.',
      'Includes custom volumetric light marching with Henyey-Greenstein phase functions to produce realistic atmospheric haze, crepuscular rays, and specular microfacet scattering.',
      'Optimized with bounding sphere early-outs and adaptive ray step sizing to maintain steady 60 FPS on mobile browsers.',
    ],
    gallery: [
      '/images/tantalize/connect.webp',
      '/images/tantalize/projects.webp',
  ...
  },
  {
    ...
    title: 'Zero-Allocation Stream Engine',
    description: 'An ultra-low latency distributed message streaming engine written in Go, featuring zero-allocation ring buffers and memory-mapped append-only logs.',
    thumbnail: '/images/tantalize/timeline.webp',
    githubUrl: 'https://github.com/AxelS27',
    tags: [
      'Go',
      'Distributed Systems',
    ...
    year: '2025',
    content: [
      'Built to explore mechanical sympathy in systems programming, this streaming engine achieves over 2.4 million messages per second on a single commodity node.',
      'Utilizes lock-free circular ring buffers (Disruptor pattern) and explicit CPU cache line padding to prevent false sharing under high concurrency.',
      'Persistence is handled via OS page cache exploitation with mmap, guaranteeing zero-copy network-to-disk packet transfers.',
    ],
    gallery: [
      '/images/tantalize/timeline.webp',
      '/images/tantalize/archives.webp',
  ...
  {
    id: 'graph-rag',
    title: 'Knowledge Graph RAG Engine',
    description: 'A hybrid retrieval-augmented generation framework combining dense vector embeddings with structured knowledge graph traversal in Neo4j.',
    thumbnail: 'https://media.liemaxels.com/images/career-trace/binus-anggrek.webp',
    githubUrl: 'https://github.com/AxelS27',
    tags: [
      'Neo4j',
      'LangChain',
    ...
    client: 'Applied AI Laboratory',
    role: 'AI Researcher',
    year: '2026',
    content: [
      'Addresses hallucination and multi-hop reasoning deficits in standard vector-only RAG pipelines by anchoring document chunks to entity-relation graphs.',
      'When a query arrives, the system performs simultaneous semantic vector search and subgraph traversal, synthesizing structured ontology facts with unstructured passages.',
      'Demonstrates a 38% reduction in factual hallucination rates on complex multi-hop benchmark question answering sets.',
    ],
    gallery: [
      'https://media.liemaxels.com/images/career-trace/binus-anggrek.webp',
      '/images/tantalize/home.webp',
    ],
  },
  {
    ...
    description: 'A pure NumPy and Python quantum state vector simulator supporting arbitrary unitary gates, multi-qubit entanglement, and measurement collapse.',
    thumbnail: 'https://media.liemaxels.com/images/career-trace/online-tutoring.webp',
    githubUrl: 'https://github.com/AxelS27',
    tags: [
      'Python',
      'NumPy',
    ...
    client: 'Quantum Computing Research',
    role: 'Lead Developer',
    year: '2025',
    content: [
      'A simulator for quantum circuits up to 20 qubits using tensor contraction and matrix Kronecker products.',
      'Supports standard quantum gates (Hadamard, CNOT, Pauli-X/Y/Z, Toffoli, Phase) and custom parameterized unitary matrices.',
      'Includes interactive Bloch sphere visualizers and density matrix entropy calculations for quantum decoherence analysis.',
    ],
    gallery: [
      'https://media.liemaxels.com/images/career-trace/online-tutoring.webp',
      '/images/tantalize/certificates.webp',
    ],
  },
  {
    id: 'swift-neural',
    title: 'CoreML Neural Style Transfer',
    description: 'An on-device real-time neural style transfer camera app for iOS leveraging Apple Metal Performance Shaders and 8-bit quantized CoreML models.',
    thumbnail: 'https://media.liemaxels.com/images/career-trace/apple-academy.webp',
    githubUrl: 'https://github.com/AxelS27',
    tags: [
      'Swift',
    ...
    client: 'Apple Developer Academy Project',
    role: 'iOS & ML Engineer',
    year: '2025',
    content: [
      'A real-time style transfer camera capturing 1080p 60 FPS video and transforming frames into Renaissance oil painting aesthetics directly on the Apple Neural Engine (ANE).',
      'Employs quantization-aware training to compress Feedforward Style Transfer models from 45MB down to 3.2MB with zero perceptual loss in texture quality.',
      'Custom Metal compute shaders manage pixel buffer conversions and zero-copy rendering directly into MTKView.',
    ],
    gallery: [
      'https://media.liemaxels.com/images/career-trace/apple-academy.webp',
      '/images/tantalize/projects.webp',
...
export const projectPages = [
  ...
  allProjects.slice(12, 18),
  allProjects.slice(18, 24),
];
